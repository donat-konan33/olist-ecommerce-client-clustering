...
class RFMSClusteringModel:
    ...
    def fit(self, X_ref):
        ...
        # baseline data
        self.X_ref_preprocessed = self.pipeline.named_steps["preprocessor"].transform(X_ref)
    ...
    def transform(self, X_cur):
        ...
        X_cur_embedding = self.umap_transformer.transform(X_cur_preprocessed) # representative drift
    ...
    def get_xref_preprocessed(self, is_contained_feature: bool=True):
        ...
        try:
            ...
            print(f"Likely data is not still fitted So it is {self.X_preprocessed} value: {e}")
    ...
    def dbcv(self):
        ...
        return self.labels_, self.nb_cluster, self.noise_ratio, self.clustered_ratio, self.dbcv_score
